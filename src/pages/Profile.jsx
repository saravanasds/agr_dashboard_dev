            ...
            <div className='flex flex-col justify-center items-center lg:flex-row px-5 '>
                ...
                <form className='lg:w-1/2 w-full justify-center items-center bg-[#F4F6F9] pb-5 m-5 shadow-md border-2 border-gray-300'>
                    ...
                    <div className='flex justify-center w-full px-5'>
                        <button className='w-full py-2 bg-green-700 text-white font-bold text-md mt-2 rounded-lg hover:bg-green-800 transition 2s'>Save Changes</button>
                    </div>
                </form>
            ...
            <div className='bg-white w-full'>
                ...
                <div className='flex flex-col justify-center items-center lg:flex-row px-5' >
                    <form className='lg:w-1/2 w-full justify-center items-center bg-[#F4F6F9] pb-5 m-5 shadow-md border-2 border-gray-300'>
                        ...
                        <div className='flex justify-center w-full px-5'>
                            <button className='py-2 px-8 w-full bg-green-700 text-white font-bold text-md mt-2 rounded-lg hover:bg-green-800 transition 2s'>Save Changes</button>
                        </div>
                    </form>
