    ...
    return (
        <>
            ...
            <div className='bg-white  w-full'>
                <h2 className='sm:text-2xl text-center font-semibold uppercase tracking-wide py-4 bg-gray-200 mx-5 xl:mx-12'>Profile Details</h2>
                <div className='bg-[#F4F6F9] mx-5 xl:mx-12 flex flex-col lg:flex-row py-5 justify-center'>
                    ...
                    <div className='w-full xl:w-1/3 flex justify-center items-center' >
                        <div className='bg-white border-4 border-gray-500 h-[200px] w-[200px] md:h-[250px] md:w-[250px] rounded-[50%] '>
                            <img src="assets/1679057404284.jpg" alt="" className='rounded-full border-white border-4' />
                        </div>
                    </div>
...
function ProfilePage() {
    ...
    return (
        <>
         <div className='text-left w-full bg-gray-200 mb-3'><h1 className='text-2xl font-bold py-3 px-10 uppercase tracking-wider'>Profie updates</h1></div>
            <div className=' pt-5'>
