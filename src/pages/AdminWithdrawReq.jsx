                                ...
                                <table className="min-w-full">
                                    <thead className="bg-[#455d7a]">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Request ID</th>
                                            ...
                                            <th className="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Bank Name</th>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-300">
                                        {requests.map((request, index) => (
                                            <tr key={request.withdrawRequestId}>
                                                ...
                                                <td className="px-6 py-4 text-center text-xs sm:text-sm whitespace-nowrap">{formatDate(request.date)}</td>
                                                <td className="px-6 py-4 text-center text-xs sm:text-sm whitespace-nowrap">{request.name}</td>
                                                <td className="px-6 py-4 text-center text-xs sm:text-sm whitespace-nowrap">{request.withdrawRequestId}</td>
                                                <td className="px-6 py-4 text-center text-xs sm:text-sm whitespace-nowrap">{request.levelIncome}</td>
                                                <td className="px-6 py-4 text-center text-xs sm:text-sm whitespace-nowrap">{request.referralIncome}</td>
                                                <td className="px-6 py-4 text-center text-xs sm:text-sm whitespace-nowrap">{request.bankName}</td>
                    ...
                    <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 flex flex-col justify-center items-center ">
                                <h2 className="text-xl font-semibold mb-4">Are You Sure Confirm to Activate?</h2>
