...
const Level = () => {
    ...
    const calculateLevelCount = (allChildLength) => {
        const levels = new Array(10).fill(0); // Initialize an array for 10 levels with zero count
            ...
            <div className='w-full h-16 bg-[#2d4059] flex justify-between items-center py-3 px-10'>
                ...
                <div className='rounded-full flex justify-center items-center'>
                    {profilePhoto ? (
                        ...
                        <div className='rounded-full border-2 h-12 w-12 flex justify-center items-center bg-gray-400'>N/A</div>
                    )}
                </div>
            </div>
